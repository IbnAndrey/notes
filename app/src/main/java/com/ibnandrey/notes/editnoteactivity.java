        ...
        msaveeditnote.setOnClickListener(v -> {
            ...
            else
            {
                ...
                documentReference.set(note).addOnSuccessListener(aVoid -> {
                    Toast.makeText(getApplicationContext(),"Замітку оновлено",Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(editnoteactivity.this,notesactivity.class));
                }).addOnFailureListener(e -> Toast.makeText(getApplicationContext(),"Помилка оновлення",Toast.LENGTH_SHORT).show());
            }
